...
@if (Route::has('login'))
    ...
    <a href="{{ url('/home') }}"><button type="" class="bouttonOne  btn-lg px-4 ">Aceuil</button></a>
        ...
        <a href="{{ route('register') }}"><button type="" class="bouttonOne  btn-lg px-4 ">Instription</button></a>
...
@endif
      ...
      <div class="col-lg-4 offset-lg-1 p-0 overflow-hidden shadow-lg">
          <!-- <img class="rounded-lg-3" src="image/logo 2.png" alt="" width="720"> -->
          <img src="assets/img/image/login4.png" class=" d-block mx-lg-auto img-fluid " alt="" width="700" height="500" loading="lazy">
  ...
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-bottom">
    <div class="col-md-4 d-flex align-items-center">
      <span class="footerSpan mb-3 mb-md-0 "> Powered by kbertrant &copy; 2023 Votre facturier2.0</span>
    </div>
