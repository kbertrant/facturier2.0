            ...
            <div class="flex-grow-1 mt-3 mt-sm-5">
                <div class="row invoice-preview">
                    ...
                    <div class="col-xl-12 col-md-12 col-12 mb-md-0 mb-4 invoice-actions">
                        <div class="card">
                            <div class="card-body">
                                <a href="/proforma/generate/{{ $pro->id }}">
                                    <button class="btn btn-primary d-grid w-100 mb-3">
                                        <span class="d-flex align-items-center justify-content-center text-nowrap"><i
                                                class="bx bx-download bx-xs me-1"></i>Download</span>
                                    </button>
                                </a>
                                <a href="/proforma/validate/{{ $pro->id }}">
                                    <button class="btn btn-primary d-grid w-100">
                                        <span class="d-flex align-items-center justify-content-center text-nowrap"><i
                                                class="bx bx-upload bx-xs me-1"></i>Generate invoice</span>
                                    </button>
                                </a>
                            </div>
                        </div>
