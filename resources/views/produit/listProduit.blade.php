    ...
    <div class="user-profile-header d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
      <div class="flex-grow-1 mt-3 mt-sm-5">
        <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
          ...
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo"><i class='bx bx-check me-1'></i>Ajouter un Produit</button> 
        </div><br>
        <div class="card">
  ...
  window.onload = function(){
       $(document).ready(function(){
              ...
              columns: [
                  ...
                  { data: 'code_prod', name: 'code_prod' },
                  { data: 'name_prod', name: 'name_prod' },
                  { data: 'desc_prod', name: 'desc_prod' },
                  { data: 'price_prod', name: 'price_prod' },
                  { data: 'qty_prod', name: 'qty_prod' },
                  { data: 'color_prod', name: 'color_prod' },
                  { data: 'size_prod', name: 'size_prod' },
                  { data: 'status', name: 'status' },
                  { data: 'id_cat', name: 'id_cat' },
                  { data: 'id_ent', name: 'id_ent' },
