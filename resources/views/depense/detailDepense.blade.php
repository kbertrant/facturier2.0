...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">Details </span> Depense #{{$dep->ref_dep}}
    </h4>
    @if (session('success'))
      ...
      <div class="flex-grow-1 mt-3 mt-sm-5">
        <div class="row invoice-preview">
                ...
                <div class="card-body">
                  <div class="row p-sm-3 p-0">
                    <div class="col-xl-6 col-md-12 col-sm-5 col-12 mb-xl-0 mb-md-4 mb-sm-0 mb-4">
                      ...
                      <p class="mb-1">{{$four->four_name}}</p>
                      <p class="mb-1">{{$four->four_rccm}}</p>
                      <p class="mb-1">{{$four->four_adress}}</p>
                      <p class="mb-1">{{$four->four_phone}}</p>
                      <p class="mb-0">{{$four->four_email}}</p>
                    </div>
                    <div class="col-xl-6 col-md-12 col-sm-7 col-12">
                      <h6 class="pb-2">Receipt To:</h6>
                      <table>
                        <tbody>
                            <tr>
                                <td class="pe-3">Total Due:</td>
                                <td>{{$dep->amount_dep}} XAF</td>
                            </tr>
                            <tr>
                                <td class="pe-3">Fournisseur:</td>
                                <td>{{$four->four_name}}</td>
                            </tr>
                            <tr>
                                <td class="pe-3">Registre commerce:</td>
                                <td>{{$four->four_rccm}}</td>
                            </tr>
                  ...
                  <table class="table border-top m-0">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-nowrap">{{ $dep->label_dep }}</td>
            ...
            <div class="col-xl-12 col-md-12 col-12 mb-md-0 mb-4 invoice-actions">
              <div class="card">
                <div class="card-body">
                    <a href="/depense/generate/{{$dep->id}}">
